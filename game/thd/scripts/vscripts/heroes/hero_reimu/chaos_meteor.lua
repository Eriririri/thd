...
function invoker_chaos_meteor_datadriven_on_spell_start(keys)
	...
	local chaos_meteor_fly_particle_effect = ParticleManager:CreateParticle("particles/thd2/heroes/reimu/reimu_01_effect_b.vpcf", PATTACH_ABSORIGIN, keys.caster)
