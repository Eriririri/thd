...
--	ParticleManager:CreateParticle("particles/items_fx/blink_dagger_start.vpcf", PATTACH_ABSORIGIN, keys.caster)	
	ParticleManager:CreateParticle("particles/econ/events/ti8/blink_dagger_ti8_start.vpcf", PATTACH_ABSORIGIN, keys.caster)
...
--	ParticleManager:CreateParticle("particles/items_fx/blink_dagger_end.vpcf", PATTACH_ABSORIGIN, keys.caster)
	ParticleManager:CreateParticle("particles/econ/events/ti8/blink_dagger_ti8_end.vpcf", PATTACH_ABSORIGIN, keys.caster)	
end
